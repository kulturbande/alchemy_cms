...
RSpec.describe Alchemy::Page::UrlPath do
  ...
  context "with wildcard params" do
    ...
    subject(:url) { described_class.new(page, wildcard_params: {id: 42}).call }
  ...
  context "with wildcard params as ActionController::Parameters" do
    ...
    subject(:url) { described_class.new(page, wildcard_params: ActionController::Parameters.new({id: 42})).call }
  ...
  context "with wildcard and query params mixed" do
    ...
    subject(:url) { described_class.new(page, {page: 2}, wildcard_params: {id: 42}).call }
